...
messn1=L"<input type=\"button\" value=\"ОТКРЫТЬ\" name=\"cmd:42350\" ><input type=\"button\" value=\"ЗАКРЫТЬ\" name=\"cmd:700\" > <br><font color=\"#ff0090\">--"+mesfrom2+L"-- </font><br><font color=\"#000090\">"+messn2+L"</font><br>";
...
mesfrom2=utf8::utf8_wchar(c->getFullName());
 messn1=L"<img height=32 width=32 alt=\" "+filePathavatar5+L".jpg\" src=\""+filePathavatar5+L".jpg\"  />"+L"<input type=\"button\" value=\"ОТКРЫТЬ\" name=\"cmd:42350\" ><input type=\"button\" value=\"ЗАКРЫТЬ\" name=\"cmd:700\" > <br><font color=\"#ff0090\">--"+mesfrom2+L"-- </font><br><font color=\"#000090\">"+messn2+L"</font><br>";
...
bufc=contact;
	...
	statusMessage1=L"<br><input type=\"button\" value=\"ОТКРЫТЬ\" name=\"cmd:42350\" ><input type=\"button\" value=\"ЗАКРЫТЬ\" name=\"cmd:700\" ><br>"+utf8::utf8_wchar(contact->getFullName())+statvs+L" <br>"+utf8::utf8_wchar(statusMessage2);
