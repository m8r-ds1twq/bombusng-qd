...
//}
    ...
    statvs=L"<br>установил статус:<br>"+utf8::utf8_wchar(typevs);
		...
		if(typevs=="chat")	statusMessage1=L"<br><input type=\"button\" value=\"ОТКРЫТЬ\" name=\"cmd:42350\" ><input type=\"button\" value=\"ЗАКРЫТЬ\" name=\"cmd:700\" ><body bgcolor=\"#53ff53\"><br><b><br><font color=\"#000000\">"+utf8::utf8_wchar(contact->getFullName())+statvs+L" </b><br>"+encloseHTML(utf8::utf8_wchar(statusMessage2))+L" </font></body>";
		if(typevs=="away")	statusMessage1=L"<br><input type=\"button\" value=\"ОТКРЫТЬ\" name=\"cmd:42350\" ><input type=\"button\" value=\"ЗАКРЫТЬ\" name=\"cmd:700\" ><body bgcolor=\"#00cccc\"><br><b><font color=\"#000000\">"+utf8::utf8_wchar(contact->getFullName())+statvs+L" </b><br>"+encloseHTML(utf8::utf8_wchar(statusMessage2))+L" </font></body>";
		if(typevs=="xa")	statusMessage1=L"<br><input type=\"button\" value=\"ОТКРЫТЬ\" name=\"cmd:42350\" ><input type=\"button\" value=\"ЗАКРЫТЬ\" name=\"cmd:700\" ><body bgcolor=\"#7975cb\"><br><b><font color=\"#000000\">"+utf8::utf8_wchar(contact->getFullName())+statvs+L" </b><br>"+encloseHTML(utf8::utf8_wchar(statusMessage2))+L" </font></body>";
		if(typevs=="dnd")	statusMessage1=L"<br><input type=\"button\" value=\"ОТКРЫТЬ\" name=\"cmd:42350\" ><input type=\"button\" value=\"ЗАКРЫТЬ\" name=\"cmd:700\" ><body bgcolor=\"#cc0000\"><br><b><font color=\"#000000\">"+utf8::utf8_wchar(contact->getFullName())+statvs+L" </b><br>"+encloseHTML(utf8::utf8_wchar(statusMessage2))+L" </font></body>";
		if(typevs=="online")	statusMessage1=L"<br><input type=\"button\" value=\"ОТКРЫТЬ\" name=\"cmd:42350\" ><input type=\"button\" value=\"ЗАКРЫТЬ\" name=\"cmd:700\" ><body bgcolor=\"#ffffff\"><br><b><font color=\"#000000\">"+utf8::utf8_wchar(contact->getFullName())+statvs+L" </b><br>"+encloseHTML(utf8::utf8_wchar(statusMessage2))+L" </font></body>";
		if(typevs=="offline")	statusMessage1=L"<br><input type=\"button\" value=\"ОТКРЫТЬ\" name=\"cmd:42350\" ><input type=\"button\" value=\"ЗАКРЫТЬ\" name=\"cmd:700\" ><body bgcolor=\"#777777\"><br><b><font color=\"#ffffff\">"+utf8::utf8_wchar(contact->getFullName())+statvs+L" </b><br>"+encloseHTML(utf8::utf8_wchar(statusMessage2))+L" </font></body>";
