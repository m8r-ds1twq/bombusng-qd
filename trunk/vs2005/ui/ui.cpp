...
std::wstring filePathavatar5=L"file://"+appRootPath+L"userdata\\avatars\\"+utf8::utf8_wchar(c->jid.getBareJid());
 ...
 messn1=L"<img height=40 width=40 alt=\" "+filePathavatar5+L".jpg\" src=\""+filePathavatar5+L".jpg\"  />"+L"<input type=\"button\" value=\"ОТКРЫТЬ\" name=\"cmd:42350\" ><input type=\"button\" value=\"ЗАКРЫТЬ\" name=\"cmd:700\" > <body bgcolor=\"";
