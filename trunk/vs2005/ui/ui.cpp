...
SHNotificationRemove(&APP_GUID, NOTIFY_ID);
					 //colorsload();
					break;
				case 98553://ЛУЧШЕ ЦИФРА ИБО МЕНЯТЬСЯ МОЖЕТ
...
std::wstring messn1=L"<input type=\"button\" value=\"ОТКРЫТЬ\" name=\"cmd:98553\" ><input type=\"button\" value=\"ЗАКРЫТЬ\" name=\"cmd:700\" > <br><font color=\"#ff0090\">--"+mesfrom2+L"-- </font><br><font color=\"#000090\">"+messn2+L"</font><br>";
SHNotificationRemove(&APP_GUID, NOTIFY_ID);
...
//}
	...
	statusMessage1=L"<br><input type=\"button\" value=\"ОТКРЫТЬ\" name=\"cmd:98553\" ><input type=\"button\" value=\"ЗАКРЫТЬ\" name=\"cmd:700\" ><br>"+utf8::utf8_wchar(contact->getFullName())+statvs+L" <br>"+utf8::utf8_wchar(statusMessage2);
